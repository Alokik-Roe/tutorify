              ...
              SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Stack(
                        children: [
                          Container(
                            ...
                            child: Image.asset("assets/homeImg_1.jpg", fit: BoxFit.fill,width: screenWidth*686,),
                          ),

                          Container(
                            alignment: Alignment.topLeft,
                            padding: EdgeInsets.only(left: 110*screenWidth, top: 90*screenWidth),
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 30*screenWidth,),
                                ...
                                ElevatedButton(
                                  ...
                                  style: ElevatedButton.styleFrom(
                                    ...
                                    padding: EdgeInsets.symmetric(horizontal: 60*screenWidth, vertical: 20),
                      ...
                      Container(
                        padding: EdgeInsets.only(left: 110*screenWidth, top: 90*screenWidth, right: 200*screenWidth),
                        child: Row(
                          children: [
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                            ...
                            SizedBox(width: 120*screenWidth,),
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                SizedBox(
                                ...
                                Row(
                                  ...
                                  children: [
                                    Container(
                                      // padding: EdgeInsets.only(right: 90*screenWidth),
                                      child: Image.asset("assets/homeImg_2.png", width: 550*screenWidth,height: 90*screenWidth,fit:BoxFit.fitWidth),
                                    ),
                                    SizedBox(width: 30*screenWidth,),
                                    Text(
                                      "View all",
                      ...
                      Container(
                        padding: EdgeInsets.only(left: 110*screenWidth, top:60*screenWidth, right: 110*screenWidth),
                        child: Row(
                          children: [
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(height: 40*screenWidth,),
                                  Row(
                                    children: [
                                      ElevatedButton(
                                        onPressed: () {
                                      ...
                                      OutlinedButton(
                                        ...
                                        style: OutlinedButton.styleFrom(
                                          // backgroundColor: HexColor("#253428"),
                                          primary: HexColor("#FB9C46"),
                                          side: BorderSide(width:4*screenWidth, color:HexColor("#FB9C46")),
                                          padding: EdgeInsets.symmetric(horizontal: 60*screenWidth, vertical: 30),
                                          shape: RoundedRectangleBorder(
                                              borderRadius: BorderRadius.circular(8.0)
                                          ),
                            ...
                            Container(
                              ...
                              alignment: Alignment.topRight,
                              // padding: EdgeInsets.only(right: 90*screenWidth),
                              child: Image.asset("assets/homeImg_3.jpg", fit: BoxFit.fill,width: screenWidth*600,),
                            ),
                      ...
                      Container(
                        ...
                        padding: EdgeInsets.only(right: 110*screenWidth,left: 110*screenWidth,top: 80-screenWidth),
                        child: Image.asset("assets/homeImg_4.jpg", fit: BoxFit.fill, width: double.maxFinite,),
                      ),
                      Container(
                        alignment: Alignment.center,
                        padding: EdgeInsets.only(right: 110*screenWidth,left: 110*screenWidth,top: 80-screenWidth),
                        child: Image.asset("assets/homeImg_5.jpg", fit: BoxFit.fill, width: double.maxFinite,),
                      ),
                      Container(
                        alignment: Alignment.center,
                        padding: EdgeInsets.only(right: 110*screenWidth,left: 110*screenWidth,top: 80-screenWidth),
                        child: Image.asset("assets/homeImg_6.jpg", fit: BoxFit.fill, width: double.maxFinite,),
                      ),
                      Container(
                        alignment: Alignment.center,
                        padding: EdgeInsets.only(right: 110*screenWidth,left: 110*screenWidth,top: 80-screenWidth, bottom: 80*screenWidth),
                        child: Image.asset("assets/homeImg_7.jpg", fit: BoxFit.fill, width: double.maxFinite,),
                      ),
